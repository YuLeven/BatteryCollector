...
public:
	...
	// @param PowerChange This is the amount to change the power by
...
protected:
	...
	// Called when we press a key to collect any pikcups inside the CollectionSphere
	...
	//Multiplier frot the character speed
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected = "true"))
	float SpeedFactor;
...
public:
	...
	//Returns CllectionSphere subobject
